    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><i class="material-icons md-light md-48">keyboard_arrow_left</i></div><div class="' + SLIDES_ARROW_NEXT + '"><i class="material-icons md-light md-48">keyboard_arrow_right</i></div>');
